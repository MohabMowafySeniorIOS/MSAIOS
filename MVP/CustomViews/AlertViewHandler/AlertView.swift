...
//  MVP
//
//  Created by Mohab Mowafy on 09/04/2021.
//
    ...
    private func setup() {
        switch type {
            ...
            case .warning:
                ...
                imageView.image = nil
            case .error:
                backgroundColor = #colorLiteral(red: 1, green: 0.1568627506, blue: 0.07450980693, alpha: 1)
                imageView.image = #imageLiteral(resourceName: "outline_error_white_24dp")
        }
        
        imageView.tintColor = .white
        messageLable.textColor = .white
        messageLable.text = message
        messageLable.font = AppFont.Regular.size(14)
