...
final class PortfolioViewModel: ObservableObject {
    ...
    @Published private(set) var summary = PortfolioSummary(itemCount: 0, totalInvested: 0, totalCurrentValue: 0)
    ...
    private func rebuild(raw: [PortfolioItem], gold: GoldPrices?, silver: SilverPrices?) {
        let valued = raw.map {
