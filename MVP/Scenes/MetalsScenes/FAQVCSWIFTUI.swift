...
struct FAQVCSWIFTUI: View {
    ...
    var body: some View {
            ...
            VStack(spacing: 16) {
                ...
                ScrollView {
                    VStack(spacing: 14) {
                        // لا نستخدم EnumeratedSequence مباشرة هنا؛ بعض إصدارات
                        // SwiftUI على المحاكي بتعمل crash أثناء بناء هذا النوع.
                        ForEach(viewModel.ModelFAQ.indices, id: \.self) { index in
                            FAQCard(
                                item: viewModel.ModelFAQ[index],
