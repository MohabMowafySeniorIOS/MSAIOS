...
//        self.present(alert, animated: true, completion: nil)
    ...
    func changeLanguage(Type:Language_cases) {
        ...
        /*
         * اللغة بتحدّد إشعاراته كمان، مش الواجهة بس.
         *
         * الاشتراك في توبيكات FCM بقى بلغة المستخدم، والسيرفر بيبعت
         * الإشعار الموجّه باللغة المسجّلة عنده. من غير السطرين دول
         * المستخدم اللي غيّر لغته كان هيفضل يستقبل بلغته القديمة.
         *
         * الدالة دي هي اللي شاشة اختيار اللغة بتناديها فعلاً
         * (`ChooseLanguageVCFirst`) — مش اللي في `AppDelegate`.
         */
